...
使用方法(到openclash配置文件处更新订阅链接)
    ...
    https://api.dler.io/sub?target=clash&new_name=true&url=你的订阅链接(需要使用URL编码，)&config=https%3A%2F%2Fraw.githubusercontent.com%2Fhxh19950701%2Fchatgpt-openclash%2Fmain%2FFull.ini
